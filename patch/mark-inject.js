...
<style>
  #AIRP_BADGE{position:fixed;bottom:6px;left:50%;transform:translateX(-50%);z-index:99999;
...
<div id="AIRP_BADGE">羽蝉NIKKI · 开源程序 · 仅供学习交流 · 完全免费 · 如果收费，恭喜你被骗了 · QQ群获取正确渠道</div>
<!-- ══ 羽蝉NIKKI 定制标记结束 ══ -->`;
